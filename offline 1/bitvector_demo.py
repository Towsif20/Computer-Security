...
i = BitVector(hexstring="12")
b63 = BitVector(hexstring="63")
b = i.gf_MI(AES_modulus, 8)
s = b63 ^ b ^ (b<<1) ^ (b<<1) ^ (b<<1) ^ (b<<1)
print((hex(s.intValue())))

s = BitVector(intVal=(0xc9), size=8)
b = BitVector(intVal=5, size=8) ^ (s<<1) ^ (s<<2) ^(s<<3)
i = b.gf_MI(AES_modulus, 8).get_bitvector_in_hex()
print(i)